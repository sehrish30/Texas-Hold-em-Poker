...
class CardTest(unittest.TestCase):
    ...
    def test_can_create_standard_52_cards(self):
       ...
       # testing that the first and last card is same
        self.assertEqual(
            cards[0],
     ...
     # since two cards object refer to different places in memory testing through attributes
    def test_figures_out_if_cards_are_equal(self):
        self.assertEqual(
             Card(rank = "2", suit = "Hearts"),
             Card(rank = "2", suit = "Hearts")
         )
